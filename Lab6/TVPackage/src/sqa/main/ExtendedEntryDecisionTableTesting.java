...
class ExtendedEntryDecisionTableTesting {
	...
	@DisplayName("Extended Entey Decision Table Test")
	void testExtendedEntryDecisionCases(String pack, boolean offline, boolean live, boolean discount, double expected) {
	...
	@CsvSource({
		"STANDARD,PREMIUM,false,false,false,0",
		",false,false,false,0",
		",false,false,false,0"
	})
